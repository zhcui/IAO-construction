...
# Modified by Zhihao Cui <zcui@caltech.edu>
#
...
def iao(mol, orbocc, minao=MINAO, scf_basis=False, **kwargs):
    ...
    if not scf_basis:
        ...
        if "ref_basis" in kwargs:
            ...
            ref_basis = 'minao'
        info = atom_scf.atom_scf(mol, ref_basis=ref_basis)
        B2 = atom_scf.get_B2(info)
        s1, s2, s12 = atom_scf.get_S1_S2_S12(B2, mol)
